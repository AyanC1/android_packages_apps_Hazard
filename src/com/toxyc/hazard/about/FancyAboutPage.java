...
package com.toxyc.hazard.about;
...
import com.toxyc.hazard.about.DiagonalView;

import com.android.settings.R;

public class FancyAboutPage extends RelativeLayout {
    private TextView l1,l2,jbcname,esromname,rkschunkname,matheeusafname,kleyname,joshuaname,zjrname,jbcdescription,esromdescription,rkschunkdescription,matheeusafdescription,kleydescription,joshuadescription,zjrdescription;
    DiagonalView diagonalView;
    ImageView jbc,esrom,rk,matheeusaf,kley,joshua,zjr,gg,tl,tw,git;
    ...
    private void init(Context context) {
        ...
        zjrname=(TextView) findViewById(R.id.zjrname);
        ...
        zjrdescription=(TextView) findViewById(R.id.zjrdescription);
        ...
        zjr=(ImageView) findViewById(R.id.zjr);
    ...
    public void setAppDescription(String AppDescription){
        ...
        zjrdescription.setText(AppDescription);
    }
