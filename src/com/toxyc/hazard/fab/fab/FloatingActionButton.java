...
import com.toxyc.hazard.fab.viewhelper.view.ViewHelper;
import com.toxyc.hazard.fab.viewhelper.view.ViewPropertyAnimator;
...
public class FloatingActionButton extends ImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mColorDisabled = getColor(R.color.material_blue_500);
        mType = TYPE_NORMAL;
        mShadow = true;
