...
import com.toxyc.hazard.fab.rebound.ui.Util;
import com.toxyc.hazard.fab.fab.FloatingActionButton;
import com.toxyc.hazard.fab.backboard.Actor;
import com.toxyc.hazard.fab.backboard.MotionProperty;
import com.toxyc.hazard.fab.backboard.imitator.Imitator;
import com.toxyc.hazard.fab.backboard.imitator.SpringImitator;
import com.toxyc.hazard.fab.backboard.performer.MapPerformer;
...
//        addView(mContainerView);
    ...
    public static class Builder {
        ...
        @ColorRes
        private int revealColor = R.color.material_blue_500;
        ...
        public Builder addMenuItem(int label, @ColorRes int textColor, @ColorRes int bgColor,
                                   int icon, View.OnClickListener onClickListener) {
            menuItems.add(new MenuItem(label, textColor, bgColor, icon, onClickListener));
            return this;
        }

        public Builder addMenuItem(int label, @ColorRes int textColor, @ColorRes int bgColor,
                                   int icon, int diameter, View.OnClickListener onClickListener) {
            menuItems.add(new MenuItem(label, textColor, bgColor, icon, diameter, onClickListener));
            return this;
        }
