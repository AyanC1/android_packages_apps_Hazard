package com.toxyc.hazard.fab.backboard;
...
import com.toxyc.hazard.fab.rebound.Spring;
import com.toxyc.hazard.fab.rebound.SpringListener;
import com.toxyc.hazard.fab.rebound.SpringSystem;
import com.toxyc.hazard.fab.backboard.imitator.EventImitator;
import com.toxyc.hazard.fab.backboard.imitator.Imitator;
import com.toxyc.hazard.fab.backboard.imitator.MotionImitator;
import com.toxyc.hazard.fab.backboard.performer.Performer;

import java.util.ArrayList;
import java.util.List;

/**
 * Coordinates the relationship between {@link com.toxyc.hazard.fab.backboard.imitator.MotionImitator}s,
 * {@link com.toxyc.hazard.fab.rebound.Spring}s, and {@link com.toxyc.hazard.fab.backboard.performer.Performer}s on a
...
public final class Actor {
	...
	public static class Builder {
		...
		/**
		 * Animates the given view with the default {@link com.toxyc.hazard.fab.rebound.SpringConfig} and
		 * automatically creates a {@link com.toxyc.hazard.fab.rebound.SpringSystem}.
		 *
		 * @param springSystem
		...
		/**
		 * Uses the default {@link com.toxyc.hazard.fab.rebound.SpringConfig} to animate the view.
		 *
		 * @param properties
		...
		/**
		 * @param spring
		 * 		the underlying {@link com.toxyc.hazard.fab.rebound.Spring}.
		 * @param properties
		 * 		the event fields to imitate and the view properties to animate.
		 * @return this builder for chaining
		 */
		...
		/**
		 * Uses a default {@link com.toxyc.hazard.fab.rebound.SpringConfig}.
		 *
		 * @param eventImitator
		 * 		maps an event to a {@link com.toxyc.hazard.fab.rebound.Spring}
		 ...
		 * 		maps an event to a {@link com.toxyc.hazard.fab.rebound.Spring}
		 * @param performers
		 * 		map the {@link com.toxyc.hazard.fab.rebound.Spring} to a
		 * 		{@link android.view.View}
		 * @return the builder for chaining
		 */
		@NonNull
