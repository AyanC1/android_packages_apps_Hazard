...
/**
 * Used by {@link com.toxyc.hazard.fab.backboard.Actor} and
 * {@link com.toxyc.hazard.fab.backboard.imitator.MotionImitator} to determine which axis to use when mapping
...
public enum MotionProperty {
	...
	/**
	 * @return the view property that this {@link com.toxyc.hazard.fab.backboard.MotionProperty}
	 * corresponds to
	 */
	@NonNull
