...
/**
 * Maps a {@link android.view.MotionEvent} to a {@link com.toxyc.hazard.fab.rebound.Spring},
...
public abstract class EventImitator extends Imitator {
	...
	/**
	 * Called by a {@link com.toxyc.hazard.fab.backboard.imitator.MotionImitator} (or another {@link
	...
	/**
	 * Maps a user's motion to {@link android.view.View} via a {@link com.toxyc.hazard.fab.rebound.Spring}.
	 *
	 * @param view
	 * 		the view to perturb.
	 * @param event
