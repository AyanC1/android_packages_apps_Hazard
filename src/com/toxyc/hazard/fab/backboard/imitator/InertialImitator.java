package com.toxyc.hazard.fab.backboard.imitator;

import android.support.annotation.NonNull;
import android.view.MotionEvent;
import com.toxyc.hazard.fab.rebound.Spring;
import com.toxyc.hazard.fab.rebound.SpringConfig;
import com.toxyc.hazard.fab.rebound.SpringListener;
import com.toxyc.hazard.fab.backboard.MotionProperty;

/**
 * A {@link com.toxyc.hazard.fab.backboard.imitator.ConstrainedMotionImitator} that moves freely when the
 * user is not dragging it. It copies the {@link com.toxyc.hazard.fab.rebound.SpringConfig} in
 * {@link #setSpring(com.toxyc.hazard.fab.rebound.Spring)} to use when the user is dragging.
 * <p>
...
public class InertialImitator extends ConstrainedMotionImitator implements SpringListener {
	...
	/**
	 * The friction (in {@link com.toxyc.hazard.fab.rebound.SpringConfig}) to use when moving freely.
	 */
	public static final float DEFAULT_FRICTION = 1.0f;

	/**
	 * The {@link com.toxyc.hazard.fab.rebound.SpringConfig} to use when moving freely.
	 */
	public static final SpringConfig SPRING_CONFIG_FRICTION = new SpringConfig(0, DEFAULT_FRICTION);

	/**
	 * Used to convert {@link com.toxyc.hazard.fab.rebound.Spring#getVelocity()} to the units needed by
	...
	/**
	 * Sets the {@link com.toxyc.hazard.fab.rebound.Spring} that this imitator should use. This class
	 * attaches itself as a {@link com.toxyc.hazard.fab.rebound.SpringListener} and stores the
	 * {@link com.toxyc.hazard.fab.rebound.SpringConfig} to use when the user is dragging.
	 *
	 * @param spring
	 * 		the spring to use
	 */
